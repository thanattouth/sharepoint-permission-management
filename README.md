...
Audit entries are written to the centralized `PermissionAuditLog` list configured by `NEXT_PUBLIC_AUDIT_SITE`, while each record still stores the affected site, library, and item metadata for traceability.
